...
<div id="menu">
	...
	<div class="container">
	{!!Form::open(['route' => 'juntasSys.store', 'method'=>'Post'])!!}
	<h4>Registrar Cliente</h4>
		...
		<button class="btn waves-effect waves-light left" type="submit" name="action" style="margin-right: 2em" > {!!Form::submit('Registrar Junta')!!}</button>
    {!!Form::close()!!}
